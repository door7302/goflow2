...
func (d *UdpDriver) Prepare() error {
	...
	flag.BoolVar(&d.packPb, "transport.udp.pack_pb", false, "Use this option to pack several pb message per UDP pkts. fixlen option is requiered")
